            ...
            <div dir='ltr'>
                ...
                <table border='0' cellpadding='0' cellspacing='0'>
                    <tbody>
                        <tr>
                            <td>
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>เรียน&nbsp;{data.DeliveryInfo.CustomerFullName}</span></span></div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            ใบยืนยันการซื้อ/ขายหลักทรัพย์/ใบเสร็จรับเงิน/ใบสำคัญจ่ายเงิน/ใบกำกับภาษี และหรือใบนำฝาก/ใบรับเงิน และหรือ ใบคำขอถอนเงิน ที่ท่านได้รับจาก<br>
                                            บริษัท หลักทรัพย์ไทยพาณิชย์ จำกัด ตามเอกสารที่แนบมานี้ ท่านสามารถเปิดดูได้ด้วยรหัสผ่านของท่าน ซึ่งรหัสผ่านของท่านคือ เลขวันเดือนปี (ค.ศ.) เกิดของท่าน<br>
                                            ในรูปของ DDMMYYYY (เช่น วันเกิดของท่านคือวันที่ 31 มกราคม ค.ศ.1999 รหัสผ่านคือ 31011999)
                                        </span>
                                    </span>
                                </div>
                                <div>
                                ...
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>ขอแสดงความนับถือ</span></span></div>
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>บริษัทหลักทรัพย์ ไทยพาณิชย์ จำกัด</span></span></div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            &nbsp;
                                ...
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>ข้อสังเกต:</span></span></div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. อีเมลฉบับนี้เป็นการแจ้งข้อมูลจากระบบโดยอัตโนมัติ กรุณาอย่าตอบกลับ หากท่านมีข้อสงสัยหรือต้องการสอบถามรายละเอียดเพิ่มเติม กรุณาติดต่อ ฝ่ายชำระราคา<br>
                                            บริษัทหลักทรัพย์ ไทยพาณิชย์ จำกัด หมายเลขโทรศัพท์ 02-949-1209, 02-949-1205 หรือ ฝ่ายลูกค้าสัมพันธ์ หมายเลขโทรศัพท์ 02-949-1999 (วันจันทร์ถึงศุกร์<br>
                                            ระหว่างเวลา 8.30 – 17.30 น. ยกเว้นวันหยุดของตลาดหลักทรัพย์แห่งประเทศไทย)
                                        </span>
                                    </span>
                                </div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. เอกสารที่แนบมานี้จะอยู่ในรูปแบบ PDF ซึ่งเปิดดูได้ด้วยโปรแกรม Adobe Reader เวอร์ชั่น 6.0 ขึ้นไป (ท่านสามารถดาวน์โหลดโปรแกรมได้ที่เว็บไซต์ โดยพิมพ์ URL
                                ...
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>To&nbsp;{data.DeliveryInfo.CustomerFullName}</span></span></div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            Confirmation Note/Receipt/ Payment Voucher/Tax Invoice and or Deposit/Receive Slip and or Cash Withdrawal Slip you receive from SCB Securities Company<br>
                                            Limited as attached herewith may be viewed with your password which is your birthdate DDMMYYYY (for example, if your birthdate is 31 January 1999, your<br>
                                            password will be 31011999).
                                        </span>
                                    </span>
                                </div>
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>Yours sincerely,</span></span></div>
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>SCB Securities Company Limited</span></span></div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            &nbsp;
                                ...
                                <div><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>Remarks:</span></span></div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. This e-mail is distributed automatically, please do not reply. Should you have any questions or require further information, please contact Settlement<br>
                                            Department, SCB Securities Company Limited, Tel: 02-949-1209, 02-949-1205 or Call Center, Tel: 02-949-1999 (Monday to Friday from 8:30 to 17:30,<br>
                                            except&nbsp;
                                        </span>
                                    </span><span style='font-size:14.0pt'><span style='font-family:cordia new,sans-serif'>holidays observed by the Stock Exchange of Thailand).</span></span>
                                </div>
                                <div>
                                    <span style='font-size:14.0pt'>
                                        <span style='font-family:cordia new,sans-serif'>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. The attached documents are PDF files that can be viewed with Adobe Reader version 6.0 or later (downloadable at URL
                                            <a href='http://www.adobe.com' target='_blank'>http://www.adobe.com</a>).
                                        </span>
                                    </span>
                                </div>
